...
static constexpr int OVL_H = 536;
static constexpr int OVL_ROW_COUNT = 14;
...
static LRESULT CALLBACK OverlayWndProc(HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam) {
    ...
    case WM_LBUTTONDOWN: {
        ...
        bool* flags[] = {
            ...
            &t.InfiniteFood, &t.InfiniteWater, &t.SpeedHack, &t.FreeCraft, &t.InfiniteItems,
            &t.NoWeight, &t.TimeLock, &t.StableTemperature, &t.MegaExp
        };
        const char* names[] = {
            "GodMode", "Stamina", "Armor", "Oxygen", "Food",
            "Water", "Speed", "Craft", "Items",
            "Weight", "TimeLock", "StableTemp", "MegaExp"
        };
